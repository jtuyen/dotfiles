...
spoon.ShiftIt:bindHotkeys({
    ...
    botright = {{ 'shift', 'ctrl', 'alt', 'cmd' }, '4' },
    maximum = {{ 'shift', 'ctrl', 'alt', 'cmd' }, 'm' },
    center = {{ 'shift', 'ctrl', 'alt', 'cmd' }, 'v' },
    nextScreen = {{ 'shift', 'ctrl', 'alt', 'cmd' }, 't' },
    previousScreen = {{ 'shift', 'ctrl', 'alt', 'cmd' }, 'r' },
})
